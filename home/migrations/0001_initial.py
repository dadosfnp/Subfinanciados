# Generated by Django 5.2.7 on 2026-08-03 13:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('regiao', models.CharField(db_index=True, max_length=255)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagem_url', models.URLField(blank=True, help_text="Cole o link de compartilhamento da imagem. Funciona com Google Drive (o arquivo precisa estar como 'Qualquer pessoa com o link'), Imgur ou qualquer URL pública direta (.jpg/.png).", max_length=500, null=True, verbose_name='Link da Imagem de Capa')),
        ...
        migrations.CreateModel(
            name='Cadunico',
            fields=[
                ('municipio', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='cadunico', serialize=False, to='home.municipio')),
        ...
        migrations.CreateModel(
            name='ContaDetalhada',
            fields=[
                ('municipio', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='conta_detalhada', serialize=False, to='home.municipio')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('municipio', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='conta_detalhada_percentil', serialize=False, to='home.municipio')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('municipio', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='conta_especifica', serialize=False, to='home.municipio')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('municipio', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='conta_especifica_percentil', serialize=False, to='home.municipio')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('municipio', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='conta_mais_especifica', serialize=False, to='home.municipio')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('municipio', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='conta_mais_especifica_percentil', serialize=False, to='home.municipio')),
        ...
        migrations.CreateModel(
            name='Indicadores2000',
            fields=[
                ('municipio', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='dados_2000', serialize=False, to='home.municipio')),
                ('populacao_00', models.IntegerField(blank=True, null=True)),
                ('rc_00', models.FloatField(blank=True, null=True)),
                ('rc_00_pc', models.FloatField(blank=True, null=True)),
                ('quintil_00', models.CharField(blank=True, max_length=50, null=True)),
                ('decil_00', models.CharField(blank=True, max_length=50, null=True)),
                ('percentil_00', models.CharField(blank=True, max_length=50, null=True)),
                ('percentil_00_n', models.IntegerField(blank=True, null=True)),
                ('rank_nacional_00', models.IntegerField(blank=True, null=True)),
                ('total_nacional_00', models.IntegerField(blank=True, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='IndicadoresAtuais',
            fields=[
                ('municipio', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='dados_atuais', serialize=False, to='home.municipio')),
                ('populacao_atual', models.IntegerField(db_index=True, null=True)),
                ('populacao_atual_rank_nacional', models.IntegerField(blank=True, null=True)),
                ('populacao_atual_total_nacional', models.IntegerField(blank=True, null=True)),
                ('populacao_atual_rank_estadual', models.IntegerField(blank=True, null=True)),
                ('populacao_atual_total_estadual', models.IntegerField(blank=True, null=True)),
                ('populacao_atual_rank_faixa', models.IntegerField(blank=True, null=True)),
                ('populacao_atual_total_faixa', models.IntegerField(blank=True, null=True)),
                ('rc_atual', models.FloatField(blank=True, null=True)),
                ('rc_atual_pc', models.FloatField(blank=True, db_index=True, null=True)),
                ('quintil_atual', models.CharField(blank=True, db_index=True, max_length=50, null=True)),
                ('decil_atual', models.CharField(blank=True, db_index=True, max_length=50, null=True)),
                ('percentil_atual', models.CharField(blank=True, max_length=50, null=True)),
                ('percentil_atual_n', models.IntegerField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            name='SusDependente',
            fields=[
                ('municipio', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='sus_dependente', serialize=False, to='home.municipio')),

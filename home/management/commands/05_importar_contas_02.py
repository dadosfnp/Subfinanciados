"""Importa ContaMaisEspecifica e ContaMaisEspecificaPercentil (nivel 2) das planilhas de base_datas.
...
class Command(BaseCommand):
    help = "Importa ContaMaisEspecifica e ContaMaisEspecificaPercentil (nivel 2) das planilhas de base_datas."
    ...
    def handle(self, *args, **options):
        ...
        for _, row in df.iterrows():
            try:
                ...
                ContaMaisEspecifica.objects.create(
                    ...
                    imposto_icms = row['itc_imp_cms'],
                    imposto_ipva = row['itc_imp_pva'],
                    ...
                    transferencia_uniao_fpe = row['trf_uni_fpe'],
        ...
        colunas_receita = [
            ...
            'perc_itc_imp_cms_pc_nac',
            'perc_itc_imp_pva_pc_nac',
            ...
            'perc_itc_imp_cms_pc_faixa',
            'perc_itc_imp_pva_pc_faixa',
            ...
            'perc_itc_imp_cms_pc_uf',
            'perc_itc_imp_pva_pc_uf',
        ...
        for _, row in df.iterrows():
            try:
                ...
                ContaMaisEspecificaPercentil.objects.create(
                    ...
                    imposto_renda_nacional = row['perc_itc_imp_rnd_pc_nac'],
                    imposto_icms_nacional = row['perc_itc_imp_cms_pc_nac'],
                    imposto_ipva_nacional = row['perc_itc_imp_pva_pc_nac'],
                    ...
                    transferencia_uniao_fpe_nacional = row['perc_trf_uni_fpe_pc_nac'],
                    ...
                    imposto_renda_regional = row['perc_itc_imp_rnd_pc_faixa'], 
                    imposto_icms_regional = row['perc_itc_imp_cms_pc_faixa'],
                    imposto_ipva_regional = row['perc_itc_imp_pva_pc_faixa'],         
                    ...
                    transferencia_uniao_fpe_regional = row['perc_trf_uni_fpe_pc_faixa'],
                    ...
                    imposto_renda_estadual = row['perc_itc_imp_rnd_pc_uf'],
                    imposto_icms_estadual = row['perc_itc_imp_cms_pc_uf'],
                    imposto_ipva_estadual = row['perc_itc_imp_pva_pc_uf'],
                    ...
                    transferencia_uniao_fpe_estadual = row['perc_trf_uni_fpe_pc_uf'],
